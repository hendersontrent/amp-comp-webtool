#------------ Dimension reduction interface from {pilfer} - https://github.com/hendersontrent/pilfer ------------
...
#' tmp <- rbind(ar1, noise)
#'
#' features <- purloiner::extract_features(tmp,
#'   group_var = "group",
#'   feature_set = "catch22")
#'
#' pca <- reduce_dimensions(features,
#'   norm_method = "zScore",
#'   low_dim_method = "PCA")
#' }
#'

reduce_dimensions <- function(data, norm_method = c("zScore", "Sigmoid", "RobustSigmoid", "MinMax"), unit_int = FALSE,
